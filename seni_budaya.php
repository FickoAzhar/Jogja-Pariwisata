...
$ambil = query("SELECT * FROM tb_senibudaya");

//Ketika tombol cari ditekan
if(isset($_POST ["search_senibudaya"])){
	$ambil = search_senibudaya($_POST ["keyword"]);
}
		...
		<div class="container">
			...
			<div class="hiro2">
				<div class="isi-hiro">
					<div class="isi-hiro-atas">
						<a href="tampil_user.php">Home</a> > Kuliner
					</div>
					<div class="isi-hiro-tengah">
				
						<h1>Seni Budaya</h1><br>
						<h2>Menyediakan Informasi mengenai Seni Budaya yang ada di jogjakarta.</h2>
					</div>
				</div>
			</div>
			...
			<div class="content cf">
				<div class="sidebar">
					<div class="isi-sidebar">
						...
						<form action="" method="post">
							...
							<input type="submit" name="search_akomodasi" value="search">
						</form>
					</div>
					<div class="isi-sidebar">
						<h1>DAFTAR WISATA</h1><hr>
							...
							<a href="masuk_senibudaya.php?id=<?php echo $row["id"]; ?>">
							<h2><?php echo $i; ?>
							<?php echo $row["nama"]; ?></h2>
							</a>
							<?php $i++; ?>
							<?php endforeach; ?>
				...
				<div class="main">
					...
					<div class="data">	
						<a href="masuk_senibudaya.php?id=<?php echo $row["id"]; ?>">
							<span><h1><?php echo $row["nama"] ?></h1></span>			
							<img src="admin/img/<?php echo $row["gambar"]; ?>" width="240" height="150"> <br>		
			...
			<footer>
			    ...
			    <div class="bottom">
			        <center>
			          	<span class="credit">Created By Kelompok XX | </span>
