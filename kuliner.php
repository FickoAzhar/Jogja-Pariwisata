			...
			<div class="hiro2">
				<div class="isi-hiro">
					...
					<div class="isi-hiro-tengah">
						...
						<h1>kuliner</h1><br>
						<h2>Menyediakan Informasi mengenai tempat kuliner yang ada. informasi bisa berupa tempat kuliner, alamat, makanan yang ditawarkan dan lokasi kuliner</h2>
					</div>
				</div>
			</div>
				...
				<div class="sidebar">
					<div class="isi-sidebar">
						...
						<div class="cari">
							<form action="" method="post">
								...
								<input type="search" name="keyword" placeholder="silahkan masukan" autocomplete="off">
					...
					<div class="isi-sidebar">
						<h1>DAFTAR WISATA</h1><hr>
							...
							<a href="masuk_kuliner.php?id=<?php echo $row["id"]; ?>">
							<h2><?php echo $i; ?>
