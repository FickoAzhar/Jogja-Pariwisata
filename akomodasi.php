...
$ambil = query("SELECT * FROM tb_akomodasi");

//Ketika tombol cari ditekan
if(isset($_POST ["search_akomodasi"])){
	$ambil = search_akomodasi ($_POST ["keyword"]);
}
			...
			<div class="hiro2">
				<div class="isi-hiro">
					...
					<div class="isi-hiro-tengah">
						...
						<h1>Akomodasi</h1><br>
						<h2>Menyediakan Informasi mengenai tempat penginapan yang ada di jogjakarta. Penginapan bisa berupa hotel dan juga homestay</h2>
					</div>
				</div>
			</div>
				...
				<div class="sidebar">
					...
					<div class="isi-sidebar">
						<h1>DAFTAR WISATA</h1><hr>
							...
							<a href="masuk_akomodasi.php?id=<?php echo $row["id"]; ?>">
							<h2><?php echo $i; ?>
