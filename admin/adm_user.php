...
$ambil = query("SELECT * FROM admin");

//Ketika tombol cari ditekan
if(isset($_POST ["cari"])){
	$ambil = search_admin ($_POST ["keyword"]);
}
...
<body>
	...
	<div class="adm_destinasi">
		...
		<div class="content">
			...
			<div class="sidebar">
				<h1>SELAMAT DATANG DI DAFTAR ADMIN,ADMIN</h1><hr>
				...
				<div class="isi-sidebar">
					...
					<div class="tambah">
						<a href="tambah_admin.php"><button>Tambah admin</button></a>
					</div>
				</div>
				...
				<div class="sidebar-main">
					<table>
						...
						<tr>
							...
							<th><a href="hapus_admin.php?id=<?php echo $row["id"] ?>" onclick = "return  confirm('anda yakin mengapus data ini?');"><i class="fas fa-trash-alt"></i></a> </th>
