...
<body>
	...
	<div class="adm_destinasi">
		...
		<div class="content">
			...
			<div class="sidebar">
				<h1>SELAMAT DATANG DI DAFTAR SENI BUDAYA,ADMIN</h1><hr>
				...
				<div class="isi-sidebar">
					...
					<div class="tambah">
						<a href="tambah_senibudaya.php"><button>Tambah data Seni Budaya</button></a>
					</div>
				</div>
				...
				<div class="sidebar-main">
					<table>
						<tr>
							<th width="2%">nomor</th>
							<th width="15%">Nama Seni Budaya</th>
						...
						<tr>
							...
							<th>
								<a href="edit_senibudaya.php?id=<?php echo $row["id"]; ?>"><i class="fas fa-pencil-alt"></i></a> |
								<a href="hapus_senibudaya.php?id=<?php echo $row["id"] ?>" onclick = "return  confirm('anda yakin mengapus data ini?');"><i class="fas fa-trash-alt"></i></a> 
