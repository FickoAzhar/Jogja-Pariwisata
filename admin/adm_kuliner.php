...
$ambil = query("SELECT * FROM tb_kuliner");

//Ketika tombol cari ditekan
if(isset($_POST ["cari"])){
	$ambil = search_kuliner ($_POST ["keyword"]);
}
...
<body>
	...
	<div class="adm_destinasi">
		...
		<div class="content">
			...
			<div class="sidebar">
				<h1>SELAMAT DATANG DI DAFTAR KULINER,ADMIN</h1><hr>
				...
				<div class="isi-sidebar">
					...
					<div class="tambah">
						<a href="tambah_kuliner.php"><button>Tambah data kuliner</button></a>
					</div>
				</div>
				...
				<div class="sidebar-main">
					<table>
						...
						<tr>
							...
							<td> <div class="lokasi"><?php echo $row["letak"]; ?></div>  </td>
							<th>
								<a href="edit_kuliner.php?id=<?php echo $row["id"]; ?>"><i class="fas fa-pencil-alt"></i></a> |
								<a href="hapus_kuliner.php?id=<?php echo $row["id"] ?>" onclick = "return  confirm('anda yakin mengapus data ini?');"><i class="fas fa-trash-alt"></i></a> 
