...
<body>
	...
	<div class="adm_destinasi">
		...
		<div class="content">
			...
			<div class="sidebar">
				<h1>SELAMAT DATANG DI DAFTAR AKOMODASI,ADMIN</h1><hr>
				...
				<div class="isi-sidebar">
					...
					<div class="tambah">
						<a href="tambah_akomodasi.php"><button>Tambah data akomodasi</button></a>
					</div>
				</div>
				...
				<div class="sidebar-main">
					<table>
						...
						<tr>
							...
							<th>
								<a href="edit_akomodasi.php?id=<?php echo $row["id"]; ?>"><i class="fas fa-pencil-alt"></i></a> |
								<a href="hapus_akomodasi.php?id=<?php echo $row["id"] ?>" onclick = "return  confirm('anda yakin mengapus data ini?');"><i class="fas fa-trash-alt"></i></a> 
